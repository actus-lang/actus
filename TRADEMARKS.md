...
The project may update this list as its public brand system develops.
...
- quote project documentation or link to the official project;
- describe an independent fork, port, plugin, library, or distribution when
  the description clearly states that it is unofficial.

Descriptive use must not imply that the Actus project has approved, sponsored,
certified, or maintains the work.
...
choose their own name, logos, and public identity.

## Official status

Official releases, packages, documentation, and services are identified only
through the project repositories and channels designated by the maintainers.
Trademark permission does not grant commit, release, repository, or
maintainer access.

## Permission requests

For a use that is not clearly permitted above, open a request in the official
project issue tracker with the proposed name, logo, distribution channel, and
the exact context of use. Until permission is granted, use a distinct name and
branding.

This policy is a project guideline, not jurisdiction-specific legal advice.
Trademark rights and registration requirements vary by country. Before filing
or enforcing a mark, obtain qualified legal advice and perform clearance
searches in the jurisdictions and software/service classes that matter.
